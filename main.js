...
import spaceTextureSrc from './space2.jpg';
import scoTextureSrc from './scofield.jpg';
...
const scoTexture = new THREE.TextureLoader().load(scoTextureSrc);

const sco = new THREE.Mesh(new THREE.BoxGeometry(3, 3, 3), new THREE.MeshBasicMaterial({ map: scoTexture }));
